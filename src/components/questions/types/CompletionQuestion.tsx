      ...
      <CardContent className="p-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Fill in the blanks with the appropriate words based on what you
            heard.
          </p>
        </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                <h4 className="font-bold text-gray-800 mb-2">
                  ...
                  {evaluationResult.partialCredit?.earned || 0}/
    ...
    blanks.forEach((blank) => {
      ...
      const blankElement = showAnswers
        ? `<span class="inline-flex items-center px-3 py-1 rounded-md border font-medium ${colorClass}">
             <span class="inline-flex items-center justify-center w-5 h-5 rounded-full bg-white text-xs font-bold mr-2">${
               blankIndex + 1
             }</span>
             ${answerText}
           </span>`
        : `<span class="inline-flex items-center px-3 py-1 rounded-md border-2 border-dashed border-gray-400 bg-gray-50 text-gray-600 font-medium">
             <span class="inline-flex items-center justify-center w-5 h-5 rounded-full bg-gray-200 text-xs font-bold mr-2">${
               blankIndex + 1
             }</span>
             ___
           </span>`;
    ...
    return (
      <div className="space-y-3">
        <h5 className="font-semibold text-gray-700 text-sm flex items-center">
          <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-gray-200 text-xs font-bold mr-2">
            ✓
          </span>
          Answer Key
        </h5>
            ...
            return (
              ...
              >
                <div className="flex items-center mb-2">
                  <span
                    className={`inline-flex items-center justify-center w-6 h-6 rounded-full ${colors.badge} text-sm font-bold mr-2`}
                  >
                    {index + 1}
                  </span>
      ...
      {showAnswers && question.explanation && (
        <div className="p-4 rounded-lg border border-blue-200 bg-blue-50">
          <h5 className="font-semibold text-blue-800 text-sm mb-2 flex items-center">
            <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-blue-100 text-xs font-bold mr-2">
              💡
            </span>
            Explanation
          </h5>
